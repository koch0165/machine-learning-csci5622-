...
def cv_performance(x, y, num_folds, k):
    ...
    for split in splits:
        ...
        train_x = [x[index] for index in split.train]
        train_y = [y[index] for index in split.train]
        test_x = [x[index] for index in split.test]
        test_y = [y[index] for index in split.test]
